...
import { acquireAgentNotificationReplyDrain } from "../agent-awareness/agentNotificationReplyDrain";
...
async function runTask(): Promise<void> {
  ...
  let releaseAgentReplies: (() => void) | null = null;
  ...
  try {
    ...
    releaseAgentReplies = acquireAgentNotificationReplyDrain();
    ...
    bestEffortCleanup("agent notification replies", releaseAgentReplies);
