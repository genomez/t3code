...
const MarkdownFileLink = memo(function MarkdownFileLink({
  ...
  }, [handleUnavailable, onReveal, outsideWorkspace, targetPath]);
  ...
  const canOpenInEditor = !outsideWorkspace && onOpen !== undefined;
  const canOpenInBrowser = !outsideWorkspace && onOpenInBrowser !== undefined;
